...
enum LocalizationKey {
    ...
    static let categorySeriesJP6 = "category.series_jp_6"
    static let categorySeriesJP7 = "category.series_jp_7"
    static let categorySeriesJP8 = "category.series_jp_8"
    static let categorySeriesJP9 = "category.series_jp_9"
    static let categorySeriesJP10 = "category.series_jp_10"
    ...
    static let categoryENSeries6 = "category.en.series_6"
    static let categoryENSeries7 = "category.en.series_7"
    static let categoryENSeries8 = "category.en.series_8"
    static let categoryENSeries9 = "category.en.series_9"
    static let categoryENSeries10 = "category.en.series_10"
    ...
    static let librarySegmentFavorites = "library.segment.favorites"
    ...
    static let libraryEmptyFavoritesTitle = "library.empty.favorites.title"
    static let libraryEmptyFavoritesDescription = "library.empty.favorites.description"
    ...
    /// ネイティブ SCP-JP / SCP（本家）フィード下部: 1000 件単位のシリーズ帯。
    static let feedTrifoldSeriesPickerCaption = "feed.trifold.series_picker.caption"
    /// ネイティブ SCP-JP / SCP フィード下部: 選択シリーズ内の 100 件ブロック。
    static let feedTrifoldHundredPickerCaption = "feed.trifold.hundred_picker.caption"
    static let feedTrifoldHundredRangeFormat = "feed.trifold.hundred.range_format"
    static let feedTrifoldBandFilterEmptyTitle = "feed.trifold.band_filter.empty.title"
    static let feedTrifoldBandFilterEmptySubtitle = "feed.trifold.band_filter.empty.subtitle"
    static let feedTrifoldJpSeries1 = "feed.trifold.jp.series_1"
    static let feedTrifoldJpSeries2 = "feed.trifold.jp.series_2"
    static let feedTrifoldJpSeries3 = "feed.trifold.jp.series_3"
    static let feedTrifoldJpSeries4 = "feed.trifold.jp.series_4"
    static let feedTrifoldJpSeries5 = "feed.trifold.jp.series_5"
    static let feedTrifoldJpSeries6 = "feed.trifold.jp.series_6"
    static let feedTrifoldJpSeries7 = "feed.trifold.jp.series_7"
    static let feedTrifoldJpSeries8 = "feed.trifold.jp.series_8"
    static let feedTrifoldJpSeries9 = "feed.trifold.jp.series_9"
    static let feedTrifoldJpSeries10 = "feed.trifold.jp.series_10"
    static let feedTrifoldEnSeries1 = "feed.trifold.en.series_1"
    static let feedTrifoldEnSeries2 = "feed.trifold.en.series_2"
    static let feedTrifoldEnSeries3 = "feed.trifold.en.series_3"
    static let feedTrifoldEnSeries4 = "feed.trifold.en.series_4"
    static let feedTrifoldEnSeries5 = "feed.trifold.en.series_5"
    static let feedTrifoldEnSeries6 = "feed.trifold.en.series_6"
    static let feedTrifoldEnSeries7 = "feed.trifold.en.series_7"
    static let feedTrifoldEnSeries8 = "feed.trifold.en.series_8"
    static let feedTrifoldEnSeries9 = "feed.trifold.en.series_9"
    static let feedTrifoldEnSeries10 = "feed.trifold.en.series_10"
    ...
    static let archiveEnSeriesBlock6 = "archive.en.series_block.6"
    static let archiveEnSeriesBlock7 = "archive.en.series_block.7"
    static let archiveEnSeriesBlock8 = "archive.en.series_block.8"
    static let archiveEnSeriesBlock9 = "archive.en.series_block.9"
    static let archiveEnSeriesBlock10 = "archive.en.series_block.10"
    ...
    static let articleReaderNavCaptionBack = "article.reader_nav.caption.back"
    static let articleReaderNavCaptionFontSize = "article.reader_nav.caption.font_size"
    static let articleReaderNavCaptionRating = "article.reader_nav.caption.rating"
    static let articleReaderNavCaptionFavorite = "article.reader_nav.caption.favorite"
    static let articleReaderNavCaptionReadLater = "article.reader_nav.caption.read_later"
    static let articleReaderNavCaptionShare = "article.reader_nav.caption.share"
    ...
    static let articleFavoriteNavAccessibility = "article.favorite.nav_accessibility"
